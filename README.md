...
Controles: clic en los botones del menú; en partida, teclado para la respuesta, `ESC` para abandonar (lleva a _Game Over_) y clic en **VOLVER** para regresar al menú.
